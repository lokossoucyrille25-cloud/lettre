export const lettresPardon = [
  {
    id: "pardon-1",
    titre: "�0cho de mon regret",
    prix: "600 FCFA",
    lienChariow: "https://lettre-tau.vercel.app",
    destinataire: "Mon Chéri / Ma Chérie",
    expediteur: "Ton �me S�ur",
    lignes: [
      { text: "Mon cher amour,", highlight: false },
      { text: "Je t'écris ces quelques mots le c�ur lourd d'un profond regret.", highlight: false },
  ...
  },
  {
    ...
    lignes: [
      ...
      { text: "Le silence qui s'est installé entre nous depuis cette dispute me déchire le c�ur.", highlight: false },
  ...
  },
  {
    ...
    lignes: [
      ...
      { text: "Mon c�ur t'appartient et il ne cherche qu'à t'apporter de la joie.", highlight: true },
  ...
  },
  {
    ...
    lignes: [
      ...
      { text: "Je viens vers toi avec toute l'humilité d'un c�ur qui reconnaît ses fautes.", highlight: false },
      ...
      { text: "Pardonne mes sautes d'humeur et mon manque de soundement durant cet instant.", highlight: true },
